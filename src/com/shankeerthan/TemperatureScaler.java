...
public class TemperatureScaler{
    ...
    private void openImage(){
         ...
         */
        switch(colorPallete){
            case Values.FUSION: palleteImage=new Image("file:"+"ColorPalletes/fusion.png"); break;
            case Values.IRONBOW_1 :palleteImage=new Image("file:"+"ColorPalletes/ironbow_1.png"); break;
            case Values.IRONBOW_2 :palleteImage=new Image("file:"+"ColorPalletes/ironbow_2.png"); break;
            case Values.RAINBOW :palleteImage=new Image("file:"+"ColorPalletes/rainbow.png"); break;
            case Values.RAIN :palleteImage=new Image("file:"+"ColorPalletes/rain.png"); break;
            case Values.SEPIA :palleteImage=new Image("file:"+"ColorPalletes/sepia.png"); break;
            case  Values.GLOWBOW :palleteImage=new Image("file:"+"ColorPalletes/glowbow.png"); break;
            case Values.WHITE_HOT :palleteImage=new Image("file:"+"ColorPalletes/white_hot.png"); break;
            case Values.BLACK_HOT :palleteImage=new Image("file:"+"ColorPalletes/black_hot.png"); break;
            case Values.ICE_AND_FIRE :palleteImage=new Image("file:"+"ColorPalletes/iceandfire.png"); break;
            case Values.COLOR_1 :palleteImage=new Image("file:"+"ColorPalletes/color1.png"); break;
            case Values.COLOR_2 :palleteImage=new Image("file:"+"ColorPalletes/color2.png");
